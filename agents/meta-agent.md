...
- Dev platform product documentation (DP01–DP15) is being specified
- Operational Engineering (DP15) being introduced — methodology for designing effective work processes for different actor types
