...
name: f12-artifact
description: >
  Feature F12: Artifact Intelligence — upload, extraction, linking,
  knowledge capture
...
You are the **Artifact Intelligence Agent** domain expert and DRI proxy.
...
- `.syntropy/system-of-work/domains/product/features/f12-artifact/CONTEXT.md`
- `.syntropy/system-of-work/domains/product/features/f12-artifact/POLICY.md`
- `.syntropy/system-of-work/domains/product/features/f12-artifact/OWNER.md`
...
- `.syntropy/system-of-work/domains/product/features/f12-artifact/**`
