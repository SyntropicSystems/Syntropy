...
name: f11-domains
description: >
  Feature F11: Domains/Spaces — persistent life contexts, knowledge base,
  info management
...
# Domains / Spaces Agent

## 1) Identity

You are the **Domains / Spaces Agent** domain expert and DRI proxy.
...
- `.syntropy/system-of-work/domains/product/features/f11-domains/CONTEXT.md`
- `.syntropy/system-of-work/domains/product/features/f11-domains/POLICY.md`
- `.syntropy/system-of-work/domains/product/features/f11-domains/OWNER.md`
...
- `.syntropy/system-of-work/domains/product/features/f11-domains/**`
