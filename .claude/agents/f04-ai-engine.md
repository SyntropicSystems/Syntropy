...
name: f04-ai-engine
description: >
  Feature F04: AI Action Engine — confidence scoring, domain agents,
  auto-execution
...
You are the **AI Engine Agent** domain expert and DRI proxy.
...
- `.syntropy/system-of-work/domains/product/features/f04-ai-engine/CONTEXT.md`
- `.syntropy/system-of-work/domains/product/features/f04-ai-engine/POLICY.md`
- `.syntropy/system-of-work/domains/product/features/f04-ai-engine/OWNER.md`
...
- `.syntropy/system-of-work/domains/product/features/f04-ai-engine/**`
