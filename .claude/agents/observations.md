...
name: observations
description: >
  Observation capture, structuring, pattern detection, contributor upleveling
...
You are the **Observations Agent** domain expert and DRI proxy.
...
- `.syntropy/system-of-work/domains/observations/CONTEXT.md`
- `.syntropy/system-of-work/domains/observations/POLICY.md`
- `.syntropy/system-of-work/domains/observations/OWNER.md`
...
- `.syntropy/system-of-work/domains/observations/**`
- `observations/**`
