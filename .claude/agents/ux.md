...
name: ux
description: >
  UX patterns, design decisions, interaction flows, prototypes
...
You are the **UX Agent** domain expert and DRI proxy.
...
- `.syntropy/system-of-work/domains/ux/CONTEXT.md`
- `.syntropy/system-of-work/domains/ux/POLICY.md`
- `.syntropy/system-of-work/domains/ux/OWNER.md`
...
- `.syntropy/system-of-work/domains/ux/**`
- `docs/product/ux/**`
- `prototypes/**`
- `surfaces/**`
