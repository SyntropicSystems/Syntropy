...
| 2026-02-22 | updated | arch-agent-architecture | Major rewrite: replaced 9 Internal Components with 22-Term Agent Ontology (5 Systems: Philosophy & Drive, Constraints, Anatomy, Mind, Execution Loop); added Entity Hierarchy (Entity → Material → Artifact → Instrument → Actor); added Affordance model and Instrumental Interface Sequence; added complete execution loop narrative; expanded system mapping with Entity levels; added 13 new ontology terms (First Principles, Principles, Doctrines, Mission, Tasks, Mechanics, Rules, Permissions, Protocols, State, Action, Effort, Observation); upgraded State to Internal State + Local Physical State; reframed Decision Profile and Design Implications in ontology terms | architecture-agent |
| 2026-02-22 | updated | glossary | Complete rewrite for 22-term ontology coherence: reorganized into 8 sections (Entity Hierarchy, Systems 1-5, Architecture Terms, Dev Platform Terms, Product Terms, Technical Terms, Workspace Terms); added ~20 new terms (Entity, Material, Instrument, Actor, Affordance, First Principles, Doctrines, Mission, Tasks, Mechanics, Rules, Permissions, Protocols, State, Action, Effort); revised all existing agent terms; eliminated stale 9-component framing; aligned every term to canonical ontology definitions | architecture-agent |
| 2026-02-22 | updated | principles | Updated Principle #11: replaced 9 Internal Components with 22-Term Agent Ontology and Entity Hierarchy; added Permissions as formal Boundary of Trust mechanism | architecture-agent |
| 2026-02-22 | updated | manifesto | Updated Heterogeneous Agent Architecture pillar: replaced 9 Internal Components with 22-Term Agent Ontology and Entity Hierarchy; added Instrument/Mission language | architecture-agent |
| 2026-02-22 | updated | arch-ai-pipeline | Rewrote pipeline stages with full ontology terms (Actions, Effort, Events, Observations, Permissions, Rules, Mechanics, Protocols); rewrote learning loop with Action/Event/Effort vocabulary; updated domain agents section | architecture-agent |
| 2026-02-22 | updated | f04 | Rewrote AI Roles with ontology terms (Actor, Mission, Action, Event, Effort, Permissions); rewrote Confidence-Based Handoff as Protocol with Permissions, Observations, and State transitions | architecture-agent |
| 2026-02-22 | updated | f10 | Rewrote confidence thresholds as Permissions mechanism; added Rules, Progressive Autonomy, and Observation vocabulary | architecture-agent |
| 2026-02-22 | updated | dp02 | Updated to 22-term ontology: Entity Hierarchy, Artifact/Instrument language for manifests; mapped manifest fields to Mission, Policies, Rules, Permissions, Protocol | architecture-agent |
| 2026-02-22 | updated | dp15 | Rewrote C3 with Mechanics constraints and Artifact/Instrument language; rewrote C4 with ontology-layer failure mapping (Mechanics, Permissions, Traits, Memory, Workflows); updated Problem section with full ontology diagnostic vocabulary | architecture-agent |
| 2026-02-22 | updated | wf-create-agent | Updated to 22-term ontology references; mapped manifest template to ontology term numbers | architecture-agent |
| 2026-02-22 | updated | arch-index | Updated Foundational section with Entity Hierarchy and 22-Term Agent Ontology description | architecture-agent |
