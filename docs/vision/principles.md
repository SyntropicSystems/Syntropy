...
refs:
  ...
  related: [coherence-engine, delivery-flow, el-anti-patterns, experience-layer, glossary, jtbd, jtbd-dev-platform, jtbd-repo-platform, jtbd-workspace-platform, personality-layer, pl-design-pillars, pl-governance]
