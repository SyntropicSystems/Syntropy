...
refs:
  ...
  related: [jtbd-dev-platform, jtbd-repo-platform, jtbd-workspace-platform, principles, stories]
tags: [vision, motivation, jtbd]
---

# Jobs to Be Done

The seven core jobs that Syntropy OS exists to fulfill. Every feature must trace back to at least one job.
