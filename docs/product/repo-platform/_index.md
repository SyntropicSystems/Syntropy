...
- **RP01** — Toolchain Version Management: Rust toolchain + Bazel version pinning across all environments → `features/rp01-runtime-version-management.md`
- **RP02** — Workspace & Module Management: Cargo workspace + Bazel module boundaries → `features/rp02-workspace-management.md`
...
- **RP04** — Project Configuration: Compiler/tooling configuration and cross-package contracts → `features/rp04-typescript-project-config.md`
...
### P1 — High Priority
- **RP07** — Infrastructure as Code: Declarative cloud resource management (deferred; backend stack TBD) → `features/rp07-infrastructure-as-code.md`
